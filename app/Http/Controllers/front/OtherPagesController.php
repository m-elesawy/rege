...
class OtherPagesController extends Controller
{
	...
	public function ourbranches(Request $request)
	{
    $getbranches = Team::select("id", "name", "designation", "fb", "youtube", "insta", "twitter", "description", "image")->orderBy('reorder_id')->get();
    return view('web.ourbranches', compact('getbranches'));
	}
